 ...
 */
package org.neuronbit.xpi.common.lang;
...
public class PrioritizedTest {
    ...
    public void testConstants() {
        assertEquals(Integer.MAX_VALUE, Prioritized.LOWEST_PRIORITY);
        assertEquals(Integer.MIN_VALUE, Prioritized.HIGHEST_PRIORITY);
    }

    @Test
    public void testGetPriority() {
        assertEquals(Prioritized.DEFAULT_PRIORITY, new Prioritized() {
        }.getPriority());
    }
