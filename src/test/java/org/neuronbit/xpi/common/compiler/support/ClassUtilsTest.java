 ...
 */
package org.neuronbit.xpi.common.compiler.support;
...
public class ClassUtilsTest {
    ...
    public void testNewInstance1() {
        Assertions.assertThrows(IllegalStateException.class, () -> ClassUtils.newInstance("org.neuronbit.xpi.common.compiler.support.internal.HelloServiceInternalImpl"));
    }

    @Test
    public void testNewInstance2() {
        Assertions.assertThrows(IllegalStateException.class, () -> ClassUtils.newInstance("org.neuronbit.xpi.common.compiler.support.internal.NotExistsImpl"));
    }

    @Test
    public void testForName() {
        ClassUtils.forName(new String[]{"org.neuronbit.xpi.common.compiler.support"}, "HelloServiceImpl0");
    }

    @Test
    public void testForName1() {
        Assertions.assertThrows(IllegalStateException.class, () -> ClassUtils.forName(new String[]{"org.neuronbit.xpi.common.compiler.support"}, "HelloServiceImplXX"));
    }
