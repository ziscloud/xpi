...
import org.neuronbit.xpi.common.logger.jcl.JclLogger;
import org.neuronbit.xpi.common.logger.jcl.JclLoggerAdapter;
import org.neuronbit.xpi.common.logger.jdk.JdkLogger;
import org.neuronbit.xpi.common.logger.jdk.JdkLoggerAdapter;
import org.neuronbit.xpi.common.logger.log4j.Log4jLogger;
import org.neuronbit.xpi.common.logger.log4j.Log4jLoggerAdapter;
import org.neuronbit.xpi.common.logger.log4j2.Log4j2Logger;
import org.neuronbit.xpi.common.logger.log4j2.Log4j2LoggerAdapter;
import org.neuronbit.xpi.common.logger.slf4j.Slf4jLogger;
import org.neuronbit.xpi.common.logger.slf4j.Slf4jLoggerAdapter;
...
public class LoggerAdapterTest {
    ...
    public void testLevel(Class<? extends LoggerAdapter> loggerAdapterClass) throws IllegalAccessException, InstantiationException {
        ...
        for (Level targetLevel : Level.values()) {
            ...
            assertThat(loggerAdapter.getLevel(), CoreMatchers.is(targetLevel));
        }
    }
}
