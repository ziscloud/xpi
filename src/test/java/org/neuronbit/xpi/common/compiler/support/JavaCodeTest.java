...
public class JavaCodeTest {
    ...
    String getSimpleCode() {
        ...
        code.append("package org.neuronbit.xpi.common.compiler.support;");
    ...
    String getSimpleCodeWithoutPackage(){
        StringBuilder code = new StringBuilder();
        code.append("public class HelloServiceImpl" + SUBFIX.getAndIncrement() + "implements HelloService.HelloService {");
        code.append("   public String sayHello() { ");
        code.append("       return \"Hello world!\"; ");
        code.append("   }");
        code.append("}");
    ...
    String getSimpleCodeWithImports() {
        ...
        code.append("import org.neuronbit.xpi.common.compiler.support;\n");
    ...
    String getSimpleCodeWithWithExtends() {
        ...
        code.append("public class HelloServiceImpl" + SUBFIX.getAndIncrement() + " extends org.neuronbit.xpi.common.compiler.support.HelloServiceImpl0 {\n");
        code.append("   public String sayHello() { ");
