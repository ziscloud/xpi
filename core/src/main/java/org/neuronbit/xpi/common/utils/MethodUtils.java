...
import static org.neuronbit.xpi.common.function.Streams.filterAll;
import static org.neuronbit.xpi.common.utils.ClassUtils.getAllInheritedTypes;
import static org.neuronbit.xpi.common.utils.StringUtils.isNotEmpty;
...
public interface MethodUtils {
    ...
    /**
     * Check if the method is a deprecated method. The standard is whether the {@link Deprecated} annotation is declared on the class.
...
//    }
    ...
    static Method findMethod(Class type, String methodName) {
        return findMethod(type, methodName, ReflectUtils.EMPTY_CLASS_ARRAY);
    }
    ...
    static <T> T invokeMethod(Object object, String methodName, Object... methodParameters) {
        ...
        try {
            final boolean isAccessible = method.canAccess(object);
